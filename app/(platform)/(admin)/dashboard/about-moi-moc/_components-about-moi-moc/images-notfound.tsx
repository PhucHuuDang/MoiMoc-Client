    ...
    <div className="flex items-center justify-center h-full w-full">
      <Card className="w-full max-w-md border-none">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl font-bold">No Images Found</CardTitle>
        </CardHeader>
        <CardContent className="flex flex-col items-center space-y-4">
          ...
          >
            ...
            <span className="text-center text-gray-600 max-w-md">
              We couldn't find any images matching your criteria. Try adjusting
              your search, uploading new images, or check out our suggestions.
            </span>
          </motion.div>
        </CardContent>
