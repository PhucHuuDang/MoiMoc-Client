...
export const Cover = ({
  children,
  className,
  classNameCoverContainer,
}: {
  children?: React.ReactNode;
  className?: string;
  classNameCoverContainer?: string;
}) => {
  ...
  return (
    <div
      ...
      ref={ref}
      className={cn(
        "group/cover relative inline-block rounded-sm bg-neutral-100 px-2 py-2 transition duration-200 hover:bg-neutral-900 dark:bg-neutral-900",
        classNameCoverContainer,
      )}
    >
      <AnimatePresence>
